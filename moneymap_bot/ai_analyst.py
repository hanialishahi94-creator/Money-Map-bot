...
## مناطق مهم قیمتی
هر سطح را به شکل Zone ارائه کن، نه عدد دقیق. اعداد را رُند و قابل استفاده برای معامله‌گر بنویس.
هر ناحیه باید بر اساس یکی از این موارد باشد: ناحیه‌ای که قیمت واکنش واضح داشته، تجمع نقدینگی، تغییر ساختار بازار، محدوده عرضه و تقاضا، یا شکست/برگشت مهم.
سطوح را صرفاً از نزدیک‌ترین سقف و کف یا اعداد خام اندیکاتور نگیر.
برای هر جهت حداقل دو منطقه ارائه بده:
حمایت نزدیک: X تا Y
حمایت مهم: X تا Y
مقاومت نزدیک: X تا Y
مقاومت مهم: X تا Y
