...
## قانون اصلی: سیگنال کامل vs بقیه

**سیگنال کامل** = پیامی که همزمان داره:
  - جهت واضح (LONG / SHORT / BUY / SELL)
  - قیمت ورود (Entry)
  - حد ضرر (Stoploss / SL)
  - حداقل یه تارگت (Target / TP)

اگه **هر کدوم** از این‌ها نبود → سیگنال کامل نیست، برو به بخش «غیر سیگنال».

---

## اگه سیگنال کامل بود:

🟢 سیگنال خرید [نام فارسی دارایی]    ← LONG/BUY
🔴 سیگنال فروش [نام فارسی دارایی]    ← SHORT/SELL
...
قوانین:
- نام دارایی فارسی: Bitcoin/BTC→بیتکوین، ETH→اتریوم، Gold/XAU/XAUUSD→طلا، EUR→یورو
- اعداد کریپتو: اعشار صفر رو حذف کن (65966.00000000 → 65,966)
- لوریج، اهرم، Leverage، LOT → حذف کامل
- تارگت‌هایی که نیستن رو ننویس

---

## اگه سیگنال کامل نبود (تحلیل، نظر، خبر، پیشنهاد ورود، هر چیز دیگه):
