...
- از این جمله‌ها استفاده نکن: «شرط فعال شدن سناریو»، «نقطه تصمیم»، «با توجه به داده‌های ارائه شده»، «بازار در حال جستجوی نقطه تعادل است»، «احتمالاً خواهد رفت»، «روند فعلی بازار نشان می‌دهد»
...
🧠 جمع‌بندی:
مثل یک تریدر صحبت کن. بگو الان باید دنبال چه چیزی باشیم و چه اتفاقی دیدگاه ما را تغییر می‌دهد."""
